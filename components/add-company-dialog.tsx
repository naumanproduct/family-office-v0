...
const companyFormFields = [
  ...
  },
  {
    ...
    options: ["Seed", "Series A", "Series B", "Series C", "Growth", "Late Stage", "Public"],
  },
  {
    id: "website",
    label: "Website",
  ...
  {
    id: "associatedInvestments",
    label: "Associated Investments",
    type: "text" as const,
  ...
  },
  {
    ...
    options: ["Active", "Inactive", "Prospective", "Past"],
  },
  {
    id: "description",
    label: "Description",
