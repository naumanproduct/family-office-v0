              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Set up automated actions and notifications</p>
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-lg border bg-card p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-medium">Stage Change Notification</h4>
                      <div className="flex items-center gap-2">
                        <Label htmlFor="rule1-enabled" className="text-xs">Enabled</Label>
                        <input
                          id="rule1-enabled"
                          type="checkbox"
                          defaultChecked
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-muted-foreground">Card moves to "Due Diligence" stage</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Badge variant="outline" className="mt-0.5">Then</Badge>
                        <span className="text-muted-foreground">Send email notification to assignee and owner</span>
                      </div>
                    </div>
                  ...
                  <div className="rounded-lg border bg-card p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-medium">Due Date Reminder</h4>
                      <div className="flex items-center gap-2">
                        <Label htmlFor="rule2-enabled" className="text-xs">Enabled</Label>
                        <input
                          id="rule2-enabled"
                          type="checkbox"
                          defaultChecked
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-start gap-2">
                        <Badge variant="outline" className="mt-0.5">When</Badge>
                        <span className="text-muted-foreground">Expected close date is 7 days away</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Badge variant="outline" className="mt-0.5">Then</Badge>
                        <span className="text-muted-foreground">Create task for owner to follow up</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 pt-2">
                      <Button variant="ghost" size="sm" className="h-7 text-xs">
                  ...
                  <div className="rounded-lg border bg-card p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-medium">Auto-assign to Team</h4>
                      <div className="flex items-center gap-2">
                        <Label htmlFor="rule3-enabled" className="text-xs">Enabled</Label>
                        <input
                          id="rule3-enabled"
                          type="checkbox"
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-start gap-2">
                        <Badge variant="outline" className="mt-0.5">When</Badge>
                        <span className="text-muted-foreground">New card is created with amount &gt; $1M</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Badge variant="outline" className="mt-0.5">Then</Badge>
                        <span className="text-muted-foreground">Assign to senior investment team</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 pt-2">
                      <Button variant="ghost" size="sm" className="h-7 text-xs">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between rounded-lg border p-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Send email when automations trigger</p>
                      </div>
                      <input
                        type="checkbox"
                        defaultChecked
                    ...
                    <div className="flex items-center justify-between rounded-lg border p-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Show notifications in the activity feed</p>
                      </div>
                      <input
                        type="checkbox"
                        defaultChecked
                    ...
                    <div className="flex items-center justify-between rounded-lg border p-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Keep logs of all automation executions</p>
                      </div>
                      <input
                        type="checkbox"
                        defaultChecked
